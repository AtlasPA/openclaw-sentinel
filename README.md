...
**Looking for automated countermeasures?** See [openclaw-sentinel-pro](https://github.com/AtlasPA/openclaw-sentinel-pro) for quarantine, blocking, community threat feeds, SBOM generation, and continuous monitoring.
...
| Feature | Free | [Pro](https://github.com/AtlasPA/openclaw-sentinel-pro) |
|---------|------|-----|
